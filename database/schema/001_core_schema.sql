...
INSERT INTO clients (username, password, email, full_name, date_of_birth, phone, registered_date, ssn, employment_status, employer_name, occupation) VALUES
    ('joanna_trader',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36gZS43O', 'joanna@example.com',  'Joanna Smith',   '1990-03-15', '555-0101', NOW() - INTERVAL '6 months', '123-45-6789', 'EMPLOYED', 'TechCorp Inc', 'Software Engineer'),
    ('david_investor', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36gZS43O', 'david@example.com',   'David Chen',     '1985-07-22', '555-0102', NOW() - INTERVAL '3 months', '234-56-7890', 'SELF_EMPLOYED', 'Chen Consulting LLC', 'Business Consultant'),
    ('priya_analyst',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36gZS43O', 'priya@example.com',   'Priya Patel',    '1995-11-08', '555-0103', NOW() - INTERVAL '1 month', '345-67-8901', 'EMPLOYED', 'FinanceFlow Analytics', 'Data Analyst');
