 ...
 *
 * <p>This bean is only created when {@code market.service.url} is explicitly configured.
 * In market-service itself, the local {@link com.lemarketjames.market.service.MarketSimulator}
 * is used instead.
 */
@ConditionalOnProperty("market.service.url")
@Service
