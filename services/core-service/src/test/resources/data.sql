...
--
-- Mirrors the instruments from database/schema/001/006/007 so orders/holdings/quotes tests have
-- real instruments to reference. Market prices themselves come from a mocked MarketDataService now
-- that market-service owns instrument_market_params (see market-service's own test fixtures) --
-- core-service has no instrument_market_params table at all anymore, so don't insert into it here.
