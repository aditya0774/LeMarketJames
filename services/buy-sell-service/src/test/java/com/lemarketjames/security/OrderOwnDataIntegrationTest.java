 ...
 * OwnDataIntegrationTest when orders became its own service (see holdings-service's
 * HoldingsOwnDataIntegrationTest for the same pattern from the holdings extraction).
 */
@SpringBootTest
@AutoConfigureMockMvc
@Transactional
class OrderOwnDataIntegrationTest {
    ...
    void seedTwoUsers() throws Exception {
        ...
        // auth-service issues this cookie in production; buy-sell-service only has to accept it.
    ...
    private Integer register(String username) {
        ...
        client.setSsn("not-used-by-buy-sell-service");
